...
<script type="text/javascript">
	...
	function del(emailId) {
		window.location.href = "emailServlet?op=delOutboxEmail&emailId="
				+ emailId + "";
	}
</script>
</head>
<body>
	...
	<div class="container-fluid">
		<div class="collapse navbar-collapse"
			...
			<form class="navbar-form navbar-left"
				action="emailServlet?op=searchEmail" method="post">
				<div class="form-group">
					<input type="hidden" value="${ACCOUNT }" name="account"> <input
						type="text" class="form-control" placeholder="请输入邮件名"
						name="search">
				</div>
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><li><a href="#" onclick="sendEmail()">我要发邮件</a></li></li>
	...
	<!-- /.container-fluid --> </nav>
	<div class="container">
		<h3 style="text-align: center">发件箱</h3>
